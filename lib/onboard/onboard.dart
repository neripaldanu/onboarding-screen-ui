...
import 'package:onboarding_example/constant.dart';
import 'package:onboarding_example/home.dart';
import 'package:onboarding_example/onboard/onboard_model.dart';
...
class _OnBoardState extends State<OnBoard> {
  int currentIndex =0;
  PageController  _pagControleller;
  List<OnBoardModel> screens = <OnBoardModel>[
    ...
    OnBoardModel(
      ...
      text: 'Dapatkan akses kapanpun dan dimanapun',
    ...
    OnBoardModel(
      ...
      desc: 'ersedia fitur Kolaborasi dengan tujuan untuk mengasah skill lebih dalam karena bias belajar bersama',
      bg: Colors.white,
      button: Color(0xFF4756DF),
    ),
  ];
  @override
  void initState() {
    _pagControleller =PageController(initialPage: 0);
    // TODO: implement initState
    super.initState();
  }
  @override
  void dispose() {
    _pagControleller.dispose();
              ...
              children: [
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: currentIndex == index ? kbrown300:kbrown,
                ...
                InkWell (
                  onTap:()async{
                    ...
                    _pagControleller.nextPage(duration: Duration(microseconds: 300), curve: Curves.bounceIn);
